...
/**
 * Export slides as images — the decisions, DOM-free. editor/exportimages.ts
 * does the pixels.
 *
...
import { inLinearFlow, type BentoDoc, type Slide } from './model'
import { fileBase, suggestedFileName } from '../../kernel/src/save'
