...
export const DATE_PRESETS: ReadonlyArray<{ token: string; label: string }> = [
  { token: '{{date}}', label: 'Datum (Betrachter-Format)' },
  { token: '{{date:D MMMM YYYY}}', label: 'Datum — 14 September 2026' },
  { token: '{{date:MMMM D, YYYY}}', label: 'Datum — September 14, 2026' },
  { token: '{{date:M/D/YY}}', label: 'Datum — 9/14/26' },
  { token: '{{date:DD/MM/YYYY}}', label: 'Datum — 14/09/2026' },
  { token: '{{date:YYYY-MM-DD}}', label: 'Datum — 2026-09-14' },
]

export const TIME_PRESETS: ReadonlyArray<{ token: string; label: string }> = [
  { token: '{{time}}', label: 'Uhrzeit (Betrachter-Format)' },
  { token: '{{time:HH:mm}}', label: 'Uhrzeit — 14:05' },
  { token: '{{time:h:mm a}}', label: 'Uhrzeit — 2:05 pm' },
]

/** The other fields, for the same picker. */
export const OTHER_FIELDS: ReadonlyArray<{ token: string; label: string }> = [
  { token: '{{page}}', label: 'Seitenzahl' },
  { token: '{{pages}}', label: 'Seitenanzahl' },
  { token: '{{title}}', label: 'Titel der Präsentation' },
  { token: '{{author}}', label: 'Autor' },
  { token: '{{company}}', label: 'Firma' },
  { token: '{{subject}}', label: 'Thema' },
  { token: '{{event}}', label: 'Anlass' },
]
